      ...
      : `<div class="grid-auto">${data.map(c => `
          <div class="card">
            ...
            <div style="margin-top:12px;display:flex;gap:8px">
              <button class="btn btn-sm btn-secondary" onclick="Pages.Academics.viewClass('${c.id}','${c.name} ${c.stream||''}')">👁 View</button>
              <button class="btn btn-sm btn-ghost" onclick="Pages.Academics.editClass('${c.id}')">✏️ Edit</button>
            </div>
          </div>`).join('')}</div>`;
  },
