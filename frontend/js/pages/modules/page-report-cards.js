...
<div class="remarks-box">
  <div style="margin-bottom:10px">
    ...
    <div style="margin-top:4px;border-bottom:1px solid #ccc;padding-bottom:4px">${s.first_name} ${s.last_name} has ${rc.mean_grade?.startsWith('A')?'performed excellently':rc.mean_grade?.startsWith('B')?'performed well':rc.mean_grade?.startsWith('C')?'performed satisfactorily':'shown room for improvement'} this term. ${attPct<80?'Attendance needs improvement. ':''}<span style="color:#999;font-style:italic">Continue working hard.</span></div>
  </div>
  <div style="margin-bottom:10px">
...
Router.define?.('report-cards', { title: 'Report Cards', onEnter: () => Pages.ReportCards.load() });
