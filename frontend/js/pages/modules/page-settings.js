        ...
        <div class="modal-body" style="padding:24px">
          ...
          <div id="mpesa-fields">
            <div style="background:#E8F5E9;border-radius:10px;padding:16px;margin-bottom:14px">
              ...
              <div style="font-size:13px">Business No: <strong>400200</strong></div>
          ...
          <div id="bank-fields" style="display:none">
            <div style="background:#E3F2FD;border-radius:10px;padding:16px;margin-bottom:14px">
              ...
              <div style="font-size:13px">Bank: <strong>Co-op Bank</strong></div>
              <div style="font-size:13px">Account: <strong>01102921238001</strong></div>
