...
Pages.Billing = {
  ...
  _render(area) {
    ...
    area.innerHTML = `
      ...
      <div style="background:#FFEBEE;border:1px solid var(--red);border-radius:10px;padding:14px;margin-bottom:20px;display:flex;align-items:center;gap:12px">
        ...
        <div><strong>Action Required:</strong> Renew your subscription to continue full access. Contact us at <a href="mailto:elimusaas@gmail.com">elimusaas@gmail.com</a> or call/WhatsApp <a href="tel:+254729612106">0729 612 106</a></div>
      </div>` : ''}
      ...
      <div class="card" style="margin-bottom:20px">
        ...
        <div style="padding:20px;display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:14px">
          ${[
            ...
            {icon:'🏦',title:'M-Pesa Paybill',desc:'Paybill: <strong>400200</strong><br>Account: Your school code',action:'paybill'},
            {icon:'💳',title:'Bank Transfer',desc:'Co-op Bank<br>A/C: 01102921238001<br>Ref: ELIMU-[School Code]',action:'bank'},
        ...
        <div class="modal-overlay open" id="billing-contact-modal" onclick="if(event.target===this)this.remove()">
          <div class="modal" style="max-width:420px">
            ...
            <div style="padding:24px;text-align:center">
              ...
              <a href="mailto:elimusaas@gmail.com?subject=Enterprise Plan Enquiry" style="display:block;padding:12px;background:var(--brand);color:white;border-radius:10px;text-decoration:none;font-weight:700;margin-bottom:10px">📧 Email Us</a>
              <a href="https://wa.me/254729612106?text=Hi, I'm interested in the Enterprise plan for ElimuSaaS" target="_blank" style="display:block;padding:12px;background:#25D366;color:white;border-radius:10px;text-decoration:none;font-weight:700">💬 WhatsApp Us</a>
            </div>
          </div>
        </div>`);
      return;
      ...
      paybill: `
        <div style="background:#E8F5E9;border-radius:10px;padding:16px;margin-bottom:16px">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:8px;font-size:13px">
            <div><span style="color:var(--text-muted)">Paybill No:</span><div style="font-weight:800;font-size:18px;color:var(--green)">400200</div></div>
      ...
      bank: `
        <div style="background:#E3F2FD;border-radius:10px;padding:16px;margin-bottom:16px">
          ...
          <div style="font-size:13px;line-height:1.8">
            Bank: <strong>Co-op Bank</strong><br>
            Account Name: <strong>ANTONY MWANGI MAINA</strong><br>
            Account No: <strong>01102921238001</strong><br>
  ...
  printReceipt(payment) {
    ...
    w.document.write(`<!DOCTYPE html><html><head><title>Receipt</title><style>body{font-family:Arial,sans-serif;padding:24px;max-width:500px;margin:0 auto}h2{color:#1565C0}.row{display:flex;justify-content:space-between;padding:7px 0;border-bottom:1px solid #eee}.label{color:#666;font-size:13px}.val{font-weight:700}@media print{button{display:none}}</style></head><body>
      ...
      <div style="margin-top:20px;text-align:center;font-size:11px;color:#999">This is an official ElimuSaaS payment receipt.<br>Contact: elimusaas@gmail.com | 0729 612 106</div>
