...
const getStudents = async (req, res) => {
  try {
    ...
    let sql = `SELECT s.id, s.admission_number, s.first_name, s.last_name, s.other_names,
                 ...
                 s.admission_date, s.dorm_name, s.blood_group, s.kcpe_index_number,
...
const createStudent = async (req, res) => {
  try {
    const {
      ...
      classId, admissionDate, isBoarding, dormName, bloodGroup, kcpeIndexNo: kcpeIndexNoRaw, kcpeIndexNumber: kcpeIndexNumRaw, photoUrl,
    ...
    await withTransaction(async (client) => {
      const { rows } = await client.query(`
        INSERT INTO students(school_id, first_name, last_name, other_names, admission_number,
          ...
          blood_group, kcpe_index_number, photo_url)
        ...
        [req.schoolId, firstName, lastName, otherNames||null, admissionNumber, gender,
         ...
         isBoarding||false, dormName||null, bloodGroup||null, (kcpeIndexNoRaw||kcpeIndexNumRaw)||null, photoUrl||null]);
