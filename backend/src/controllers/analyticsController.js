...
const getDashboardStats = async (req, res) => {
  try {
    ...
    if (!schoolId) {
      return res.json({ students:{total:0,boys:0,girls:0}, staff:{total:0}, fees:{total_collected:0}, attendance:{}, recentPayments:[], topStudents:[], charts:{attendanceTrend:[],feeTrend:[]} });
    }
