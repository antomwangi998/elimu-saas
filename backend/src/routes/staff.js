...
router.get('/my-assignments', staff, c.getMyAssignments);
router.get('/pending', admin, c.getPendingStaff);
router.post('/:id/approve', admin, c.approveStaff);
router.post('/:id/reset-password', admin, c.resetStaffPassword);
