...
class SuperAdminDashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, s: Bundle?) {
        ...
        view.findViewById<View>(R.id.btnSASchools)?.setOnClickListener { navigate(SuperAdminSchoolsFragment()) }
        view.findViewById<View>(R.id.btnSAAnalytics)?.setOnClickListener { navigate(SuperAdminAnalyticsFragment()) }
        view.findViewById<View>(R.id.btnSASubscriptions)?.setOnClickListener { navigate(SuperAdminSubscriptionsFragment()) }
        view.findViewById<View>(R.id.btnSAUsers)?.setOnClickListener { navigate(SuperAdminUsersFragment()) }
        view.findViewById<View>(R.id.btnSASettings)?.setOnClickListener { navigate(SuperAdminSettingsFragment()) }
    }
    private fun navigate(f: Fragment) = (activity as? ke.elimusaas.ui.MainActivity)?.load(f)
