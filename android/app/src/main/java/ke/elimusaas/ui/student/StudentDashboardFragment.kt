...
class StudentDashboardFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, s: Bundle?) {
        ...
        scope.launch {
            val students = withContext(Dispatchers.IO) { try { ApiClient(requireContext()).getStudents(user?.email ?: "") } catch(_:Exception){ emptyList<ke.elimusaas.data.StudentResult>() } }
